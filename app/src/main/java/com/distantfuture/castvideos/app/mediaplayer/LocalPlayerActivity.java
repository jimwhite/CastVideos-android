...
public class LocalPlayerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != b) {
            mSelectedMedia = com.distantfuture.castcompanionlibrary.lib.utils.Utils
    ...
    private void setupControlsCallbacks() {
        ...
        mVideoView.setOnPreparedListener(new OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                mEndText.setText(com.distantfuture.castcompanionlibrary.lib.utils.Utils
        ...
        mSeekbar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress,
                    boolean fromUser) {
                mStartText.setText(com.distantfuture.castcompanionlibrary.lib.utils.Utils
